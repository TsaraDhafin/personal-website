...
center">MENU</h2> 
      <ul class="space-y-2 text-gray-700"> 
        ...
        <li><a href="about.php" class="block font-semibold text-yellow-700">About</a></li> 
        <li> 
...
medium">Logout</a> 
    ...
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6"> 
      <div class="flex justify-between items-center mb-4"> 
        <h2 class="text-xl font-bold text-yellow-700">Tentang Saya</h2> 
        <a href="add_about.php" 
           class="bg-yellow-700 text-white px-4 py-2 rounded hover:bg-yellow-700 
