...
<body class="bg-yellow-100 min-h-screen"> 
  <!-- Header --> 
  <header class="bg-amber-950 text-white text-center py-6 shadow"> 
...
center">MENU</h2> 
      <ul class="space-y-2 text-gray-700"> 
        <li><a href="beranda_admin.php" class="block hover:text-yellow-700">Beranda</a></li> 
        <li><a href="data_artikel.php" class="block hover:text-yellow-700">Kelola Artikel</a></li> 
        <li><a href="data_gallery.php" class="block font-semibold text-yellow-700">Kelola Gallery</a></li> 
        <li><a href="about.php" class="block hover:text-yellow-700">About</a></li> 
        <li> 
...
medium">Logout</a> 
    ...
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6"> 
      <div class="flex justify-between items-center mb-4"> 
        <h2 class="text-xl font-bold text-yellow-700">Daftar Gallery</h2> 
        <a href="add_gallery.php" 
           class="bg-yellow-700 text-white px-4 py-2 rounded hover:bg-yellow-700 transition">+ Tambah Gambar</a> 
      </div> 
...
hover:underline'>Hapus</a>";
  ...
  <!-- Footer --> 
  <footer class="bg-amber-950 text-white text-center py-4 mt-10"> 
    &copy; <?php echo date('Y'); ?> | Created by Tsara Dhafin
  </footer> 
</body> 
</html>