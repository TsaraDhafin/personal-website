...
<!-- Sidebar --> 
    <aside class="w-1/4 bg-white rounded shadow p-4"> 
      ...
      <ul class="space-y-2 text-gray-700">
        <li><a href="beranda_admin.php" class="block hover:text-yellow-700">Beranda</a>
        </li> 
        <li><a href="data_artikel.php" class="block font-semibold text-yellow-700">Kelola Artikel</a>
        </li> 
        <li><a href="data_gallery.php" class="block hover:text-yellow-700">Kelola Gallery</a></li> 
    ...
    <main class="w-3/4 bg-white rounded shadow p-6 ml-6"> 
      <div class="flex justify-between items-center mb-4"> 
        <h2 class="text-xl font-bold text-yellow-700">Daftar Artikel</h2> 
        <a href="add_artikel.php" 
           class="bg-yellow-800 text-white px-4 py-2 rounded hover:bg-yellow-700 transition">+Tambah Artikel</a> 
      </div> 
