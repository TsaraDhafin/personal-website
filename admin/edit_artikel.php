...
<body class="bg-amber-100 min-h-screen"></body>
<!-- Header --> 
...
center">MENU</h2> 
      <ul class="space-y-2 text-gray-700"> 
        ...
        <li><a href="data_artikel.php" class="block font-semibold text-yellow-700">Kelola Artikel</a></li> 
...
<div class="flex justify-end space-x-4"> 
          <button type="submit" 
            class="bg-amber-950 text-white px-4 py-2 rounded hover:bg-yellow-700 transition">Update</button> 
